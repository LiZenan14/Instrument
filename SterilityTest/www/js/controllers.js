...
//数据录入-赵艳霞
.controller('Data_inputcontroller',['$scope','$ionicNavBarDelegate','$ionicSideMenuDelegate','$cordovaCalendar','Storage','$ionicPopover','$state','$rootScope',
  function($scope,$ionicNavBarDelegate,$ionicSideMenuDelegate,$cordovaCalendar,Storage,$ionicPopover,$state,$rootScope) {
